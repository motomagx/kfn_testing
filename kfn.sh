...
_load_language()
{
	...
	then
		...
		_WINDOWS_SUBSYSTEM_INCOMPATIBLE_MSG="não é compativel com Linux on Windows Subsystem, experimente utilizar num sistema sendo executado no VirtualBox, Vmware, QEMU, Linux-KVM ou dual-boot."
		...
		_SELECT_NUMBER_OF_THREADS="Selecione o número de núcleos a serem usados para compilar o codigo (1 to 1024).\n\nValor recomendado para este sistema:"
		...
		_KERNEL_SETUP_UTILITY="Compilando arquivos do Utilitario de Configuração do Kernel, por favor, aguarde."
		...
		_THREADS_CANNOT_BE_ZERO="Valor de tarefas não pode ser '0' ou negativo, precisa ser pelo menos '1', a menos que voce esteja na Matrix e Morpheus autorizou voce a utilizar esse valor."
		...
		_SET_PROJECT_PREFIX="Selecione o profixo a ser utilizado.\n\nNote que poderá ser utilizado somente letras (A-Z, a-z), numeros (0-9), traço, ponto e underline são recomendados.\n\nEspaço e caracteres especiais não são permitidos."
		_PROJECT_LOCATION_BUILD="Estrutura local do projeto"
		_FOLDER_IS_NOT_EMPTY="O seguinte diretorio não esta vazio:"
		...
		_DEPENDENCIES_NOT_INSTALLED="As seguintes dependências não estao instaladas:"
		_ASK_INSTALL_DEPENDECIES="Voce deseja instalar as dependeências em falta?"
		...
		_ALL_DEPENDENCIES_INSTALLED="Todas as dependências estao instaladas."
		...
		_GENERATE_CONFIG_FILE_TXT="Modifica o arquivo de configuracao .config"
		...
		_CUSTOM_PREFIX_TXT="Escolha o prefixo a ser utilziado com a versao do Kernel.\nExamplo: Kernel 3.8.10-prefixo_customizado_aqui."
